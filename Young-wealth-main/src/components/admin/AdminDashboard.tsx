...
// Example: Show AdminLogin before dashboard if not authenticated
// You may want to replace this with your actual admin auth logic
const isAdminLoggedIn = !!localStorage.getItem('youngwealth_admin');
...
export const AdminDashboard: React.FC = () => {
  ...
  const handleVideoSubmit = async (videoData: FormData) => {
    ...
    try {
      const response = await fetch(`/api/admin/courses/${selectedCourseForVideo}/videos`, {
        method: 'POST',
        body: videoData,
      });
